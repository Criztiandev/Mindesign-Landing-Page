        ...
        <div className="px-6 lg:px-12">
          ...
          <div className="grid lg:grid-cols-3 gap-12 max-w-7xl mx-auto">
              ...
              <div className="flex justify-center mb-8">
                <div className="relative w-32 h-32">
                  <svg viewBox="0 0 120 120" className="w-full h-full">
                    ...
                    />
                    {/* Screen content */}
                    <rect x="35" y="35" width="25" height="15" fill="#75fbc0" />
            ...
            >
              ...
              <div className="space-y-4">
                <h3 className="text-3xl font-black text-white">DEVELOPMENT</h3>
                <p className="text-white/80 text-lg leading-relaxed">
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <p className="text-[#303030]/80 text-lg leading-relaxed max-w-sm mx-auto">
                  ...
                  here to nurture your creativity and always offer guidance if
                  needed.
                </p>
              </div>
            </motion.div>
